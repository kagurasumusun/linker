...
#define SUPPORT_ARCH_riscv32 1

#define SUPPORT_APPLE_TV 1

#define ALL_SUPPORTED_ARCHS  "armv6 armv7 armv7s arm64 arm64e arm64_32 i386 x86_64 x86_64h armv6m armv7k armv7m armv7em riscv32 (tvOS)"
